...
Route::middleware('auth:api', 'throttle:180,1', 'locale')->group(function () {
    ...
    Route::get('/addresses', 'BuildingAPIController@tmpAddressIndex')->name('addresses');
    Route::get('/addresses/{id}', 'BuildingAPIController@tmpAddressShow')->name('addresses.show');
