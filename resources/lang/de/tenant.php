...
return [
    ...
    "heading_info" => [
        ...
        "pinboard" => "Aktuelle News rund um die Liegenschaft",
        "request" => "Lösen Sie ein Ticket für Ihr Anliegen",
        "listing" => "Aktuelle Angebote in Ihrer Nachbarschaft",
        "my_document" => "Eine Liste mit allen Dokumenten der Liegenschaft und der gemieteten Einheit.",
        "document_listed_by_category" => "Alle zur Verfügungs gestellten Dokumente werden hier aufgelistet.",
        "my_contract" => "Mein Mietvertrag",
        "my_contact" => "Meine Kontakte",
    ],
    "you" => "Du",
    "and" => "und",
    "media_info" => "Alle werden hier in Spalten aufgelistet und sind in voller Grösse zu sehen, wenn Sie mit der Maus über eine von ihnen fahren.",
    ...
    "edit_pinboard" => "Einen Beitrag bearbeiten",
    "add_request" => "Eine Anfrage hinzufügen",
    "add_listing" => "Ein Inserat hinzufügen",
    "edit_listing" => "Ein Inserat bearbeiten",
