...
return [
    ...
    "no_data" => [
        ...
        "product" => "Es sind keine Inserate verfügbar",
    ...
    "notifications" => [
        ...
        "marketplace" => "Benachrichtigung erhalten, wenn jemand ein von Ihnen veröffentlichtes Inserat kommentiert oder eine Anfrage dazu sendet.",
    ],
    "tooltips" => [
    ...
    "heading_info" => [
        ...
        "marketplace" => "Aktuelle Angebote in Ihrer Nachbarschaft",
    ...
    "add_product" => "Ein Inserat hinzufügen",
    "edit_product" => "Ein Inserat bearbeiten",
