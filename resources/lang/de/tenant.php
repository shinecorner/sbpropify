...
return [
    ...
    "no_data" => [
        ...
        "pinboard" => "Es sind keine Beitrag verfügbar.",
    ],
    "no_data_info" => [
    ...
    "notifications" => [
        ...
        "service" => "Benachrichtigung erhalten, wenn Ihre Anfrage (Ticket) den Bearbeitungsprozess durchläuft.",
    ...
    "heading_info" => [
        ...
        "pinboard" => "Aktuelle News rund um Ihr Quartier",
    ...
    "get_in_touch_info" => "Benutzen Sie den obigen Button, um zu erfahren, wie Sie den Verkäufer kontaktieren können, um dieses Produkt zu erhalten.",
    "free" => "Kostenlos",    
