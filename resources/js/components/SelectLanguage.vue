<template>
    <el-select id="languageform" :class="activeLanguage == '' ? '' : ' selected'" style="display: block" :value="activeLanguage" @input="$emit('update:activeLanguage', $event)" :placeholder="$t(`models.unit.placeholders.select`)">
