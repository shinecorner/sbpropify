...
Router.beforeEach(async (to, from, next) => {
    if (!Object.keys(store.state.application.constants).length) {
        ...
        document.documentElement.style.setProperty('--color-main-background-lighter', LightenDarkenColor(store.state.application.constants.colors.primary_color, 90) + '59' )
