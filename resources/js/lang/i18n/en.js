export default {
    "en": {
        ...
        "tenant": {
            ...
            "offer_1": "With the digital tenant dossier you have access to all relevant documents, such as Tenancy agreement, house rules or other documents relating to the property",
            "offer_2": "The ticketing system enables you to process your enquiries simply and uncomplicatedly - with the following features Communicate your concerns to the administration at any time and from any place.",
            "offer_3": "On the market and lending place you can send objects to your neighbourhood. sell or lend.",
            "offer_4": "Share news with your neighbours by publishing a contribution. The pinboard is also used by the administration for the communication, so all are always on the Running.",
            "offer_5": "Further micro apps within the application set new standards in living quality where various services can be conveniently used.",
