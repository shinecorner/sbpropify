export default {
    "it": {
        ...
        "tenant": {
            ...
            "offer_1": "Con il dossier digitale dell'inquilino avete accesso a tutti i documenti rilevanti, come il contratto di locazione, il regolamento interno o altri documenti relativi alla proprietà.",
            "offer_2": "Il sistema di ticketing vi permette di elaborare le vostre richieste in modo semplice e senza complicazioni - potete comunicare le vostre preoccupazioni all'amministrazione in qualsiasi momento e da qualsiasi luogo.",
            "offer_3": "Puoi vendere o prestare oggetti al tuo quartiere sulla piazza del mercato e sull'area di prestito.",
            "offer_4": "Condividi le notizie con i tuoi vicini pubblicando un contributo. La bacheca è utilizzata anche dall'amministrazione per la comunicazione, in modo che tutti siano sempre aggiornati.",
            "offer_5": "Ulteriori Micro-Apps all'interno dell'applicazione stabiliscono nuovi standard nella qualità della vita, per cui è possibile utilizzare comodamente diversi servizi.",
